...
Default margins are tuned for a 1920×1080 code-server/Playwright viewport:
  top    = 72   (browser chrome + VS Code tab bar)
  bottom = 24   (VS Code status bar)
  left   = 48   (VS Code activity bar strip)
  right  = 0
